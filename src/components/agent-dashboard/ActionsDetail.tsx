...
export default function InitiativeDetail({
  ...
  const fetchInitiative = async () => {
    try {
      setLoading(true);
      const response = await fetch(`/api/actions/${initiativeId}`);
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <SubredditAutocomplete
              ...
              onChange={(value) =>
                setFormData({ ...formData, subreddit: value })
              }
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 text-xs text-[#818384] mb-2">
                  <span className="text-[#D7DADC] font-medium">
                    r/{formData.subreddit || "subreddit"}
                  </span>
                  <span>•</span>
                ...
                <div className="flex items-center gap-4 mt-4 text-xs text-[#818384]">
                  <button className="flex items-center gap-1 hover:bg-[#272729] px-2 py-1 rounded">
                    ...
                    <span>
                      {
                        initiative.aiInsights.similarPostsPerformance
                          .averageComments
                      }{" "}
                      Comments
                    </span>
            ...
            <div className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/10">
              ...
              <span
                className={`text-sm font-medium ${
                  initiative.aiInsights.engagementPrediction === "High"
                    ? "text-green-400"
                    : initiative.aiInsights.engagementPrediction === "Moderate"
                    ? "text-yellow-400"
                    : "text-red-400"
                }`}
              >
              ...
              <div className="grid grid-cols-2 gap-2 text-xs">
                <div>
                  ...
                  <span className="ml-1 text-white">
                    {initiative.aiInsights.similarPostsPerformance.averageKarma}
                  </span>
                </div>
                <div>
