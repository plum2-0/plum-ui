...
export default function VizSummaryView({ prospects }: VizSummaryViewProps) {
  ...
  const { funnelData, totals } = useMemo(() => {
    ...
    const funnelData = [
      { name: "Total Leads Discovered", value: totals.total_leads_discovered, prev: discoveredBase },
      { name: "Total Leads Engaged", value: totals.total_leads_engaged, prev: discoveredBase },
      { name: "Total Leads Converted", value: totals.total_leads_converted, prev: engagedBase, color: "#34D399" },
