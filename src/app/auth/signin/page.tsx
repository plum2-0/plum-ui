    ...
    <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="glass-card rounded-3xl p-8 max-w-md w-full relative z-10">
        ...
        <p className="mt-8 text-center text-sm text-white/70 font-body">
          ...
          <span className="text-white/90 hover:text-purple-300 transition-colors cursor-pointer">Terms of Service</span>
          {' '}and{' '}
          <span className="text-white/90 hover:text-purple-300 transition-colors cursor-pointer">Privacy Policy</span>
        </p>
      </div>
    </div>
  );
