  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="glass-card rounded-3xl p-8 max-w-md w-full relative z-10">
        ...
        {error && (
          <div className="glass-card rounded-lg p-4 mb-6 border-red-500/50">
        ...
        <div className="space-y-4">
          <button
            ...
            className="w-full glass-button-white hover:opacity-90 text-gray-900 font-semibold py-3 px-4 rounded-xl transition-all duration-300 flex items-center justify-center gap-3 transform hover:scale-105"
          >
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-3 glass-card rounded-full text-white/80">
          ...
          <div className="space-y-3 opacity-50">
            <button
              disabled
              className="w-full glass-card opacity-50 text-white/50 font-semibold py-3 px-4 rounded-xl cursor-not-allowed flex items-center justify-center gap-3"
            >
